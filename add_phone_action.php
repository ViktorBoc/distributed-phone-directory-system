...
$local_sql = "INSERT INTO phones (id, brand, model, price) VALUES ('$id', '$brand', '$model', $price)";
$remote_sql = "INSERT INTO phones (id, brand, model, price) VALUES ('$id', '$brand', '$model', $price)";
...
if ($local_conn->query($local_sql) === TRUE) {
    echo "Record successfully added to the local database.<br>";
} else {
